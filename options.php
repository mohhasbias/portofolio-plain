...
function optionsframework_options() {
	...
	$options[] = array(
		'name' => __('Basic Profile', 'options_check'),
		'type' => 'heading');

	$options[] = array(
		'name' => __('Full Name', 'options_check'),
...
// 		'std' => 'Default Value',
	...
	$options[] = array(
		'name' => __('Main Occupation', 'options_check'),
...
// 		'std' => 'Default',
	...
	$options[] = array(
		'name' => __('Motto', 'options_check'),
// 		'desc' => __('A text input field.', 'options_check'),
		'id' => 'motto',
		'std' => 'Make the world a better place',
		'type' => 'textarea');
	
	$options[] = array(
		'name' => __('Profile Picture', 'options_check'),
// 		'desc' => __('This creates a full size uploader that previews the image.', 'options_check'),
		'id' => 'profile_picture',
		'type' => 'upload');	

	$options[] = array(
		'name' => __('About Me', 'options_check'),
...
// 		'std' => 'Default Text',
	...
	$options[] = array(
		'name' => __('Skill Description', 'options_check'),
// 		'desc' => __('Textarea description.', 'options_check'),
...
// 		'std' => 'Default Text',
	...
	$options[] = array(
		'name' => __('Skills set', 'options_check'),
		'desc' => __('This should be a dynamic list.', 'options_check'),
		'type' => 'info');
